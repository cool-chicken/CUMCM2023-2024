...
def Solve(Element_S1, Element_S2, Test_Mark_S1, Test_Mark_S2, Test_Mark_Finished_Product, Dismantle_Mark_Finished_Product, Exchange_Quantity):
    ...
    Test_Price_S1 = 2
    Test_Price_S2 = 3
    Finished_Product_Defect_Rate = 0.05
    Finished_Product_Assemble_Price = 6
    Finished_Product_Test_Price = 3
    Finished_Product_Sell_Price = 56
    Finished_Product_Exchange_Loss = 10
    Finished_Product_Dismantle_cost = 40
    Perturbed_Finished_Product_Defect_Rate = Finished_Product_Defect_Rate + np.random.normal(0, 0.01021)
...
for i in range(0, 16):
    ...
    for j in range(0, Time):
        ...
        while k < Simulation_Number:
            ...
            Perturbed_Defect_Rate_S1 = Defect_Rate_S1 + np.random.normal(0, 0.01002)
            Perturbed_Defect_Rate_S2 = Defect_Rate_S2 + np.random.normal(0, 0.01031)
