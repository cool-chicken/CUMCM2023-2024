...
def Solve(Element_S1, Element_S2, Test_Mark_S1, Test_Mark_S2, Test_Mark_Finished_Product, Dismantle_Mark_Finished_Product, Exchange_Quantity):
    ...
    Perturbed_Finished_Product_Defect_Rate = Finished_Product_Defect_Rate + np.random.normal(0, 0.01028)
...
for i in range(0, 16):
    ...
    for j in range(0, Time):
        ...
        while k < Simulation_Number:
            ...
            Perturbed_Defect_Rate_S1 = Defect_Rate_S1 + np.random.normal(0, 0.01777)
            Perturbed_Defect_Rate_S2 = Defect_Rate_S2 + np.random.normal(0, 0.01071)
